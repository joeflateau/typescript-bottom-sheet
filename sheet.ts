...
export function touchGestureListener(el: EventTarget, start: (start: {
  ev: GestureEvent,
...
export function listen<T extends Event>(el: EventTarget, eventNames: string[], listener: (ev: T) => any): () => void {
